...
namespace CoreLibraryAPI.DbContexts
{
    public class CoreLibraryAPIContext: DbContext
    {
        public CoreLibraryAPIContext(DbContextOptions<CoreLibraryAPIContext> options): base(options)
        {
        }
